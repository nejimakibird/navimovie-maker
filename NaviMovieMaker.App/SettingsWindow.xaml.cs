...
public partial class SettingsWindow : Window
{
    ...
    private void SaveButton_Click(object sender, RoutedEventArgs e)
    {
        var settings = new AppSettings
        {
            ...
            AudioNormalizationMode = Settings.AudioNormalizationMode,
            SimpleModeEnabled = Settings.SimpleModeEnabled,
            TargetPeakDb = Settings.TargetPeakDb,
            TargetReplayGainVolumeDb = Settings.TargetReplayGainVolumeDb,
            PeakLimitDb = Settings.PeakLimitDb,
            NormalizationToleranceDb = Settings.NormalizationToleranceDb,
            MaximumNormalizationGainDb = Settings.MaximumNormalizationGainDb,
